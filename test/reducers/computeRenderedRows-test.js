...
describe('computeRenderedRows', function () {
  ...
  describe('computeRenderedRows', function () {
    ...
    it('should not update row heights and scrollContentHeight if isVerticalScrollExact=true', function () {
      const scrollAnchor = {
        firstIndex: 15,
        firstOffset: -25,
        lastIndex: undefined,
      ...
      for (let rowIdx = 13; rowIdx < 20; rowIdx++) {
        rowOffsetIntervalTreeMock.expects('set').never();
      }
