Fixed Data Table 2 for React ![Travic CI status](https://api.travis-ci.org/schrodinger/fixed-data-table-2.svg) [![Coverage Status](https://coveralls.io/repos/github/schrodinger/fixed-data-table-2/badge.svg?branch=master)](https://coveralls.io/github/schrodinger/fixed-data-table-2?branch=master) [![npm version](https://badge.fury.io/js/fixed-data-table-2.svg)](https://www.npmjs.com/package/fixed-data-table-2)
====================================
